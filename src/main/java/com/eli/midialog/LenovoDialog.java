 ...
 * 联想风格对话框
 *
 * @author liuzhu@eli-tech.com 2018/05/09
 */
public class LenovoDialog {
    final Builder builder;
    protected Dialog dialog;

    protected LenovoDialog(Builder builder) {
        this.builder = builder;
        dialog = LenovoDialogInit.init(this);
    }
    ...
    public static class Builder {
        ...
        protected boolean showConfirmCheckBox = false;// 隐藏选择按钮
        ...
        protected int negativeBgDrawable;
        ...
        public Builder(@NonNull Context context) {
            ...
            this.titleTextColor = context.getResources().getColor(R.color.color_lenovo_primary_text);
            ...
            this.promptTextColor = context.getResources().getColor(R.color.color_lenovo_primary_text);
            this.inputTextColor = context.getResources().getColor(R.color.color_lenovo_primary_text);
            ...
            this.negativeTextColor = context.getResources().getColorStateList(R.color.selector_orange_to_white);
            this.neutralTextColor = context.getResources().getColorStateList(R.color.selector_button_text_white);
            this.negativeBgDrawable = R.drawable.selector_bg_lenovo_dialog_button_left_orange;
            ...
            this.editInputType = InputType.TYPE_CLASS_TEXT;
        }
        ...
        public Builder titleTextSize(@ColorRes int size) {
        ...
        public Builder setBgDrawable(int bg) {
            this.bg = bg;
            return this;
        }

        public Builder content(@StringRes int contentRes, boolean html) {
            Object text = this.context.getText(contentRes);
            if (html) {
                text = Html.fromHtml(((CharSequence) text).toString().replace("\n", "<br/>"));
            }

            return this.content((CharSequence) text);
        }
        ...
        public Builder contentColor(@ColorRes int color) {
            this.contentTextColor = context.getResources().getColor(color);
            return this;
        }

        public Builder contentTextSize(@DimenRes int size) {
            this.contentTextSize = context.getResources().getDimension(size);
            return this;
        }
        ...
        public Builder promptTextSize(@DimenRes int size) {
        ...
        public Builder negativeBgRes(@DrawableRes int drawableRes) {
            this.negativeBgDrawable = drawableRes;
            return this;
        }
        ...
        public Builder setCheckBoxContent(@StringRes int titleRes) {
            this.setCheckBoxContent(this.context.getText(titleRes));
            return this;
        }

        public Builder setCheckBoxContent(@NonNull CharSequence text) {
            this.checkboxText = text;
            return this;
        }

        public Builder confirmCheckBox(@NonNull boolean showCheckBox) {
            this.showConfirmCheckBox = showConfirmCheckBox;
            return this;
        }
        ...
        public Builder editInputType(@Nullable int inputType) {
        ...
        @UiThread
        public LenovoDialog build() {
            return new LenovoDialog(this);
        }

        @UiThread
        public LenovoDialog show() {
            LenovoDialog dialog = this.build();
            dialog.show();
            return dialog;
        }
    ...
    public interface SingleButtonCallback {
        ...
        void onClick(@NonNull LenovoDialog dialog, @NonNull DialogAction action);
    ...
    public interface InputCallback {
        void onInput(@NonNull LenovoDialog dialog, CharSequence text);

    }

    public interface InputCallbacks {
        void onInput(@NonNull LenovoDialog dialog, CharSequence text, CharSequence confirmText);
    }

    public interface ListCallback {
        void onSelection(@NonNull LenovoDialog dialog, View v, int pos, CharSequence text);
    }

    public interface CheckBoxCallback {
        void onCheckBoxChange(@NonNull LenovoDialog dialog, boolean isChecked);
    }
}
